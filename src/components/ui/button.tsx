    ...
    return (
      <div className={cn("relative inline-block w-full", { "pb-2": showShadow })}>
        {showShadow && (
          <span
            className={cn(
              "absolute bottom-0 left-0 w-full h-full rounded-full",
              "border-2 border-blue-900 bg-primary-shadow z-0"
            )}
          />
        )}
        ...
        <Comp
          className={cn(
            "relative z-10", // Ensures button stays above shadow
